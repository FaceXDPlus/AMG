...
namespace MaterialUI
{
    ...
    public class MaterialSliderEditor : MaterialBaseEditor
    {
		...
		private SerializedProperty m_ValueTextSuffix;
        ...
        void OnEnable()
        {
			...
			m_ValueTextSuffix = serializedObject.FindProperty("m_ValueTextSuffix");
        ...
        public override void OnInspectorGUI()
        {
			...
			if (m_MaterialSlider.valueText != null)
			{
				EditorGUILayout.PropertyField(m_ValueTextSuffix);
			}
