...
namespace MaterialUI
{
    public abstract class DialogAnimator
    {
        ...
        public virtual void AnimateHideBackground()
        {
			...
			TweenManager.TweenFloat(f => background.alpha = f, background.alpha, 0f, m_AnimationDuration, 0f, () => GameObject.Destroy(background.gameObject), false, Tween.TweenType.Linear);
        }
