...
namespace MaterialUI
{
    ...
    public class MaterialSlider : UIBehaviour, ISelectHandler, IDeselectHandler, IPointerDownHandler, IPointerUpHandler, ILayoutGroup, ILayoutElement
    {
		...
		/// <summary>
		/// An option string suffix to add to the value text
		/// </summary>
		[SerializeField]
		private string m_ValueTextSuffix = "";
		...
		private bool m_DelayedInit = true;
        ...
        protected override void Start()
        {
            ...
            StartCoroutine(OnSliderValueInit());
        }
        ...
        private IEnumerator OnSliderValueInit()
        {
