...
namespace MaterialUI
{
    ...
    public static class RectTransformExtension
    {
        ...
        public static void SetPositionRegardlessOfPivot(this RectTransform rectTransform, Vector2 position)
        {
            rectTransform.position = position - new Vector2(
                (0.5f - rectTransform.pivot.x) * rectTransform.rect.width,
                (0.5f - rectTransform.pivot.y) * rectTransform.rect.height);
        }

        public static void SetLocalPositionRegardlessOfPivot(this RectTransform rectTransform, Vector2 localPosition)
        {
            rectTransform.localPosition = localPosition - new Vector2(
                (0.5f - rectTransform.pivot.x) * rectTransform.rect.width,
                (0.5f - rectTransform.pivot.y) * rectTransform.rect.height);
        }
