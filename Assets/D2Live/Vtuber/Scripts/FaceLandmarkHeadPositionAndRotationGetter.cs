...
{
    public class FaceLandmarkHeadPositionAndRotationGetter : D2LiveManagerProcess, IHeadPositionGetter, IHeadRotationGetter
    {
        [Header ("[Input]")]

        [SerializeField, InterfaceRestriction (typeof(IMatSourceGetter))]
        protected D2LiveManagerProcess matSourceGetter;
        ...
        protected D2LiveManagerProcess faceLandmarkGetter;
